...
export function resolve_localized(
...
function walk(value: unknown, locale: string): unknown {
	...
	if (obj['@type'] === LOCALIZED_TYPE) return obj[locale] ?? undefined;
	...
	if (obj['@type'] === ELEMENT_TYPE) return value;
